...
<form id="creation" method="post" action="OfferCreationController"  enctype="multipart/form-data">
<div class="form-group">
<label for="location" class="form-label">Où souhaitez-vous créer votre offre ?</label>
<input type="text" id="location" class="form-control" onkeypress="return /[0-9a-zA-Z\-éèàçôîûâê ]/i.test(event.key)" name="location" placeholder="Lieu" required>

<br/>

<label for="date_start" class="form-label">De:</label>
<input type="date" id="date_start" class="form-control" onfocus="this.min=new Date().toISOString().split('T')[0]" max="2022-12-31" name="date_start" required>



<label for="date_end" class="form-label">A:</label>
<input type="date" id="date_end" class="form-control"	onfocus="this.min=date_start.value" max="2022-12-31" name="date_end" required>

<br/>

<label for="offer_image" class="form-label">Veuillez fournir une image (PNG) de l'offre:</label>
<input type="file" id="offer_image" class="form-control" name="offer_image" accept="image/png" required>

<br/>

<label for="description" class="form-label">Décrivez votre offre:</label>
<input type="text" id="description" class="form-control" onkeypress="return /[0-9a-zA-Z\-.,éèàçôîûâê ]/i.test(event.key)" name="description" placeholder="Description" required>
